	...
	while($row_CONSULTA1 = $CONSULTA1 -> fetch_assoc()){
		...
		echo '
			<tr>
				...
				<td style="width:130px;"><input type="text" class="editarajax uk-input uk-form-small uk-text-right" data-tabla="'.$modulo.'detalle" data-campo="precio" data-id="'.$row_CONSULTA1['id'].'" value="'.$row_CONSULTA1['precio'].'" data-cantidad="'.$row_CONSULTA1['cantidad'].'" tabindex="9"></td>
